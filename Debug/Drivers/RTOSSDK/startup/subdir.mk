...
CPP_SRCS += \
../Drivers/RTOSSDK/startup/startup.cpp 

OBJS += \
./Drivers/RTOSSDK/startup/startup.o 

CPP_DEPS += \
./Drivers/RTOSSDK/startup/startup.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/RTOSSDK/startup/%.o Drivers/RTOSSDK/startup/%.su Drivers/RTOSSDK/startup/%.cyclo: ../Drivers/RTOSSDK/startup/%.cpp Drivers/RTOSSDK/startup/subdir.mk
...
clean: clean-Drivers-2f-RTOSSDK-2f-startup

clean-Drivers-2f-RTOSSDK-2f-startup:
	-$(RM) ./Drivers/RTOSSDK/startup/startup.cyclo ./Drivers/RTOSSDK/startup/startup.d ./Drivers/RTOSSDK/startup/startup.o ./Drivers/RTOSSDK/startup/startup.su

.PHONY: clean-Drivers-2f-RTOSSDK-2f-startup
