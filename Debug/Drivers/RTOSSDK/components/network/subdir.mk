...
CPP_SRCS += \
../Drivers/RTOSSDK/components/network/network.cpp 

OBJS += \
./Drivers/RTOSSDK/components/network/network.o 

CPP_DEPS += \
./Drivers/RTOSSDK/components/network/network.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/RTOSSDK/components/network/%.o Drivers/RTOSSDK/components/network/%.su Drivers/RTOSSDK/components/network/%.cyclo: ../Drivers/RTOSSDK/components/network/%.cpp Drivers/RTOSSDK/components/network/subdir.mk
...
clean: clean-Drivers-2f-RTOSSDK-2f-components-2f-network

clean-Drivers-2f-RTOSSDK-2f-components-2f-network:
	-$(RM) ./Drivers/RTOSSDK/components/network/network.cyclo ./Drivers/RTOSSDK/components/network/network.d ./Drivers/RTOSSDK/components/network/network.o ./Drivers/RTOSSDK/components/network/network.su

.PHONY: clean-Drivers-2f-RTOSSDK-2f-components-2f-network
