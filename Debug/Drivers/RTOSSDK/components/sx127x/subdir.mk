...
CPP_SRCS += \
../Drivers/RTOSSDK/components/sx127x/sx127x.cpp 

OBJS += \
./Drivers/RTOSSDK/components/sx127x/sx127x.o 

CPP_DEPS += \
./Drivers/RTOSSDK/components/sx127x/sx127x.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/RTOSSDK/components/sx127x/%.o Drivers/RTOSSDK/components/sx127x/%.su Drivers/RTOSSDK/components/sx127x/%.cyclo: ../Drivers/RTOSSDK/components/sx127x/%.cpp Drivers/RTOSSDK/components/sx127x/subdir.mk
...
clean: clean-Drivers-2f-RTOSSDK-2f-components-2f-sx127x

clean-Drivers-2f-RTOSSDK-2f-components-2f-sx127x:
	-$(RM) ./Drivers/RTOSSDK/components/sx127x/sx127x.cyclo ./Drivers/RTOSSDK/components/sx127x/sx127x.d ./Drivers/RTOSSDK/components/sx127x/sx127x.o ./Drivers/RTOSSDK/components/sx127x/sx127x.su

.PHONY: clean-Drivers-2f-RTOSSDK-2f-components-2f-sx127x
