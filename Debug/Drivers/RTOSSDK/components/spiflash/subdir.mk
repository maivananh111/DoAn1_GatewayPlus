...
CPP_SRCS += \
../Drivers/RTOSSDK/components/spiflash/spiflash.cpp 

OBJS += \
./Drivers/RTOSSDK/components/spiflash/spiflash.o 

CPP_DEPS += \
./Drivers/RTOSSDK/components/spiflash/spiflash.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/RTOSSDK/components/spiflash/%.o Drivers/RTOSSDK/components/spiflash/%.su Drivers/RTOSSDK/components/spiflash/%.cyclo: ../Drivers/RTOSSDK/components/spiflash/%.cpp Drivers/RTOSSDK/components/spiflash/subdir.mk
...
clean: clean-Drivers-2f-RTOSSDK-2f-components-2f-spiflash

clean-Drivers-2f-RTOSSDK-2f-components-2f-spiflash:
	-$(RM) ./Drivers/RTOSSDK/components/spiflash/spiflash.cyclo ./Drivers/RTOSSDK/components/spiflash/spiflash.d ./Drivers/RTOSSDK/components/spiflash/spiflash.o ./Drivers/RTOSSDK/components/spiflash/spiflash.su

.PHONY: clean-Drivers-2f-RTOSSDK-2f-components-2f-spiflash
