...
CPP_SRCS += \
../RTOSSDK/network/protocols/tcp/tcp_client.cpp 

OBJS += \
./RTOSSDK/network/protocols/tcp/tcp_client.o 

CPP_DEPS += \
./RTOSSDK/network/protocols/tcp/tcp_client.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/network/protocols/tcp/%.o RTOSSDK/network/protocols/tcp/%.su RTOSSDK/network/protocols/tcp/%.cyclo: ../RTOSSDK/network/protocols/tcp/%.cpp RTOSSDK/network/protocols/tcp/subdir.mk
...
clean: clean-RTOSSDK-2f-network-2f-protocols-2f-tcp

clean-RTOSSDK-2f-network-2f-protocols-2f-tcp:
	-$(RM) ./RTOSSDK/network/protocols/tcp/tcp_client.cyclo ./RTOSSDK/network/protocols/tcp/tcp_client.d ./RTOSSDK/network/protocols/tcp/tcp_client.o ./RTOSSDK/network/protocols/tcp/tcp_client.su

.PHONY: clean-RTOSSDK-2f-network-2f-protocols-2f-tcp
