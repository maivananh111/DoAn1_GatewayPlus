...
CPP_SRCS += \
../RTOSSDK/network/protocols/http/http.cpp \
../RTOSSDK/network/protocols/http/httpclient.cpp 

OBJS += \
./RTOSSDK/network/protocols/http/http.o \
./RTOSSDK/network/protocols/http/httpclient.o 

CPP_DEPS += \
./RTOSSDK/network/protocols/http/http.d \
./RTOSSDK/network/protocols/http/httpclient.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/network/protocols/http/%.o RTOSSDK/network/protocols/http/%.su RTOSSDK/network/protocols/http/%.cyclo: ../RTOSSDK/network/protocols/http/%.cpp RTOSSDK/network/protocols/http/subdir.mk
...
clean: clean-RTOSSDK-2f-network-2f-protocols-2f-http

clean-RTOSSDK-2f-network-2f-protocols-2f-http:
	-$(RM) ./RTOSSDK/network/protocols/http/http.cyclo ./RTOSSDK/network/protocols/http/http.d ./RTOSSDK/network/protocols/http/http.o ./RTOSSDK/network/protocols/http/http.su ./RTOSSDK/network/protocols/http/httpclient.cyclo ./RTOSSDK/network/protocols/http/httpclient.d ./RTOSSDK/network/protocols/http/httpclient.o ./RTOSSDK/network/protocols/http/httpclient.su

.PHONY: clean-RTOSSDK-2f-network-2f-protocols-2f-http
