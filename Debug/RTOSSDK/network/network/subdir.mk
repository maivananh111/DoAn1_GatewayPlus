...
CPP_SRCS += \
../RTOSSDK/network/network/netconnect.cpp 

OBJS += \
./RTOSSDK/network/network/netconnect.o 

CPP_DEPS += \
./RTOSSDK/network/network/netconnect.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/network/network/%.o RTOSSDK/network/network/%.su RTOSSDK/network/network/%.cyclo: ../RTOSSDK/network/network/%.cpp RTOSSDK/network/network/subdir.mk
...
clean: clean-RTOSSDK-2f-network-2f-network

clean-RTOSSDK-2f-network-2f-network:
	-$(RM) ./RTOSSDK/network/network/netconnect.cyclo ./RTOSSDK/network/network/netconnect.d ./RTOSSDK/network/network/netconnect.o ./RTOSSDK/network/network/netconnect.su

.PHONY: clean-RTOSSDK-2f-network-2f-network
