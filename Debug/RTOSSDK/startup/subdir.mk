...
CPP_SRCS += \
../RTOSSDK/startup/startup.cpp 

OBJS += \
./RTOSSDK/startup/startup.o 

CPP_DEPS += \
./RTOSSDK/startup/startup.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/startup/%.o RTOSSDK/startup/%.su RTOSSDK/startup/%.cyclo: ../RTOSSDK/startup/%.cpp RTOSSDK/startup/subdir.mk
...
clean: clean-RTOSSDK-2f-startup

clean-RTOSSDK-2f-startup:
	-$(RM) ./RTOSSDK/startup/startup.cyclo ./RTOSSDK/startup/startup.d ./RTOSSDK/startup/startup.o ./RTOSSDK/startup/startup.su

.PHONY: clean-RTOSSDK-2f-startup
