...
CPP_SRCS += \
../RTOSSDK/components/button/button.cpp 

OBJS += \
./RTOSSDK/components/button/button.o 

CPP_DEPS += \
./RTOSSDK/components/button/button.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/components/button/%.o RTOSSDK/components/button/%.su RTOSSDK/components/button/%.cyclo: ../RTOSSDK/components/button/%.cpp RTOSSDK/components/button/subdir.mk
...
clean: clean-RTOSSDK-2f-components-2f-button

clean-RTOSSDK-2f-components-2f-button:
	-$(RM) ./RTOSSDK/components/button/button.cyclo ./RTOSSDK/components/button/button.d ./RTOSSDK/components/button/button.o ./RTOSSDK/components/button/button.su

.PHONY: clean-RTOSSDK-2f-components-2f-button
