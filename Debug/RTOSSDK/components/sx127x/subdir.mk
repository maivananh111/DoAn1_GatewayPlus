...
CPP_SRCS += \
../RTOSSDK/components/sx127x/sx127x.cpp 

OBJS += \
./RTOSSDK/components/sx127x/sx127x.o 

CPP_DEPS += \
./RTOSSDK/components/sx127x/sx127x.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/components/sx127x/%.o RTOSSDK/components/sx127x/%.su RTOSSDK/components/sx127x/%.cyclo: ../RTOSSDK/components/sx127x/%.cpp RTOSSDK/components/sx127x/subdir.mk
...
clean: clean-RTOSSDK-2f-components-2f-sx127x

clean-RTOSSDK-2f-components-2f-sx127x:
	-$(RM) ./RTOSSDK/components/sx127x/sx127x.cyclo ./RTOSSDK/components/sx127x/sx127x.d ./RTOSSDK/components/sx127x/sx127x.o ./RTOSSDK/components/sx127x/sx127x.su

.PHONY: clean-RTOSSDK-2f-components-2f-sx127x
