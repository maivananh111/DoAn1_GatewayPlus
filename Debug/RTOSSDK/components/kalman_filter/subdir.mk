...
CPP_SRCS += \
../RTOSSDK/components/kalman_filter/kalman_filter.cpp 

OBJS += \
./RTOSSDK/components/kalman_filter/kalman_filter.o 

CPP_DEPS += \
./RTOSSDK/components/kalman_filter/kalman_filter.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/components/kalman_filter/%.o RTOSSDK/components/kalman_filter/%.su RTOSSDK/components/kalman_filter/%.cyclo: ../RTOSSDK/components/kalman_filter/%.cpp RTOSSDK/components/kalman_filter/subdir.mk
...
clean: clean-RTOSSDK-2f-components-2f-kalman_filter

clean-RTOSSDK-2f-components-2f-kalman_filter:
	-$(RM) ./RTOSSDK/components/kalman_filter/kalman_filter.cyclo ./RTOSSDK/components/kalman_filter/kalman_filter.d ./RTOSSDK/components/kalman_filter/kalman_filter.o ./RTOSSDK/components/kalman_filter/kalman_filter.su

.PHONY: clean-RTOSSDK-2f-components-2f-kalman_filter
