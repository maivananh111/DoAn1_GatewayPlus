...
CPP_SRCS += \
../RTOSSDK/components/loraif/loraif.cpp 

OBJS += \
./RTOSSDK/components/loraif/loraif.o 

CPP_DEPS += \
./RTOSSDK/components/loraif/loraif.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/components/loraif/%.o RTOSSDK/components/loraif/%.su RTOSSDK/components/loraif/%.cyclo: ../RTOSSDK/components/loraif/%.cpp RTOSSDK/components/loraif/subdir.mk
...
clean: clean-RTOSSDK-2f-components-2f-loraif

clean-RTOSSDK-2f-components-2f-loraif:
	-$(RM) ./RTOSSDK/components/loraif/loraif.cyclo ./RTOSSDK/components/loraif/loraif.d ./RTOSSDK/components/loraif/loraif.o ./RTOSSDK/components/loraif/loraif.su

.PHONY: clean-RTOSSDK-2f-components-2f-loraif
