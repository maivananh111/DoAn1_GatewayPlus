...
CPP_SRCS += \
../RTOSSDK/components/pid/pid.cpp 

OBJS += \
./RTOSSDK/components/pid/pid.o 

CPP_DEPS += \
./RTOSSDK/components/pid/pid.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/components/pid/%.o RTOSSDK/components/pid/%.su RTOSSDK/components/pid/%.cyclo: ../RTOSSDK/components/pid/%.cpp RTOSSDK/components/pid/subdir.mk
...
clean: clean-RTOSSDK-2f-components-2f-pid

clean-RTOSSDK-2f-components-2f-pid:
	-$(RM) ./RTOSSDK/components/pid/pid.cyclo ./RTOSSDK/components/pid/pid.d ./RTOSSDK/components/pid/pid.o ./RTOSSDK/components/pid/pid.su

.PHONY: clean-RTOSSDK-2f-components-2f-pid
