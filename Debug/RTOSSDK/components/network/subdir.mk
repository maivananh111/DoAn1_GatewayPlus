...
CPP_DEPS += \
./RTOSSDK/components/network/network.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/components/network/%.o RTOSSDK/components/network/%.su RTOSSDK/components/network/%.cyclo: ../RTOSSDK/components/network/%.cpp RTOSSDK/components/network/subdir.mk
...
clean: clean-RTOSSDK-2f-components-2f-network

clean-RTOSSDK-2f-components-2f-network:
	-$(RM) ./RTOSSDK/components/network/network.cyclo ./RTOSSDK/components/network/network.d ./RTOSSDK/components/network/network.o ./RTOSSDK/components/network/network.su

.PHONY: clean-RTOSSDK-2f-components-2f-network
