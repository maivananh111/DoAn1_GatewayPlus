...
CPP_SRCS += \
../RTOSSDK/components/ds3231/ds3231.cpp 

OBJS += \
./RTOSSDK/components/ds3231/ds3231.o 

CPP_DEPS += \
./RTOSSDK/components/ds3231/ds3231.d 


# Each subdirectory must supply rules for building sources it contributes
RTOSSDK/components/ds3231/%.o RTOSSDK/components/ds3231/%.su RTOSSDK/components/ds3231/%.cyclo: ../RTOSSDK/components/ds3231/%.cpp RTOSSDK/components/ds3231/subdir.mk
...
clean: clean-RTOSSDK-2f-components-2f-ds3231

clean-RTOSSDK-2f-components-2f-ds3231:
	-$(RM) ./RTOSSDK/components/ds3231/ds3231.cyclo ./RTOSSDK/components/ds3231/ds3231.d ./RTOSSDK/components/ds3231/ds3231.o ./RTOSSDK/components/ds3231/ds3231.su

.PHONY: clean-RTOSSDK-2f-components-2f-ds3231
