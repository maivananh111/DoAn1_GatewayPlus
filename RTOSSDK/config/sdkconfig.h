...
#define CONFIG_RTOS_APP_MAIN_TASK_SIZE              byte_to_word(4096)
#define CONFIG_RTOS_APP_MAIN_TASK_PRIO              1

#define CONFIG_RTOS_MAX_SYSTEM_INTERRUPT_PRIORITY   configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY // Your system interrupt priority must be greater than this number.
